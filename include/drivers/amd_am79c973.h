...
#ifndef __impzos__DRIVERS__AMD_AM79C973_H
#define __impzos__DRIVERS__AMD_AM79C973_H
...
namespace impzos{
    namespace drivers
    {
        ...
        public:
            amd_am79c973(impzos::hardwarecommunication::PeripheralComponentInterconnectDeviceDescriptor *dev,
                         impzos::hardwarecommunication::InterruptManager* interrupts);
            ~amd_am79c973();
