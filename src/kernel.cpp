...
void printf(char* str)
{
    ...
    {
        switch(str[i])
        {   // provera da li je kao parametar prosledjen \n, za novi red
            case '\n':
                x = 0;
                y++;
                break;
            ...
            for(y = 0; y < 25; y++)
                for(x = 0; x < 80; x++)
                    VideoMemory[80*y+x] = (VideoMemory[80*y+x] & 0xFF00) | ' ';
                        // ukoliko je terminal popunjen, popuniti ga opet sa "praznim prostorom"
                        //  pa setovati kursor x, y na 0
            x = 0;
            y = 0;
        }
    }
